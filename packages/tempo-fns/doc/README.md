  ...
  <tbody>
    <tr>
      <td width="100" valign="top">
        <img src="../img/tempo-fns-logo.svg" width="90" height="90" alt="Tempo-fns Logo">
      </td>
      <td valign="middle">
...
If you aren't using a bundler (like Vite, Webpack, or Rollup), we provide a pre-bundled script that exposes a `TempoFns` global object.
...
<script>
  ...
  TempoFns.isFirstDayOfMonth(Tempo.now());
</script>
```
