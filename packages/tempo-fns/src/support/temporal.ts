 ...
 * This guarantees that tempo-fns does not accidentally bundle the polyfill, 
...
export const getTemporal = (): typeof TemporalType => {
	...
	throw new Error("[tempo-fns] Temporal API is not available in the global scope. Ensure a polyfill is loaded.");
}
