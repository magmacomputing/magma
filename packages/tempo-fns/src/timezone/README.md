...
**Example:**
```typescript
import { isDST } from '@magmacomputing/tempo-fns/timezone';
...
**Example:**
```typescript
import { getOffsets } from '@magmacomputing/tempo-fns/timezone';
...
**Example:**
```typescript
import { getHemisphere } from '@magmacomputing/tempo-fns/timezone';
...
**Example:**
```typescript
import { normalizeUtcOffset } from '@magmacomputing/tempo-fns/timezone';
