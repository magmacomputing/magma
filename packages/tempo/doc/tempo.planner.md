...
This leads to performance gains and gives you deterministic control when overriding [Ambiguity Resolution](./tempo.month-day.md) heuristics (e.g. forcing `mdy` over `dmy`).
