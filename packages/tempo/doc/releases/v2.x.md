...
## [v2.8.0] - 2026-04-30
### 🚨 Release D: Pervasive Hard-Freeze Proxies
- Refactored the immutability system to use mutation-throwing Proxies for all immutable objects, replacing `Object.freeze`.
- All mutation attempts on immutable objects now throw explicit errors, even in non-strict environments.
