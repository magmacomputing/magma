/**
 * Tempo Plugin API Facade (Super Barrel)
 * 
 * This file serves as the single, unified public endpoint for external Premium Plugins.
 * It consolidates all necessary granular internal utilities (core, library, terms, etc.)
 * into one importable path (`@magmacomputing/tempo/plugin-api`).
 * 
 * ARCHITECTURE NOTE:
...
export * from './plugin/plugin.index.js';
