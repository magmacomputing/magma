...
const features = [
  ...
  { title: 'Humanizing Temporal', details: 'Transforming low-level Temporal complexity into intuitive, expressive APIs—anchored in a rock-solid ISO 8601 baseline with native regional calendar awareness.', icon: '🧭' },
