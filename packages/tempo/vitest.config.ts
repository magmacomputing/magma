...
export default defineConfig({
  ...
  test: {
    ...
    setupFiles: [resolve(__dirname, './bin/setup.polyfill.ts')],
  ...
  resolve: {
    alias: isDist ? [
      ...
      { find: /^#library\/(.*)\.js$/, replacement: resolve(__dirname, './dist/lib/$1.js') },
      { find: /^#library$/, replacement: resolve(__dirname, './dist/lib/common.index.js') },
    ] : [
