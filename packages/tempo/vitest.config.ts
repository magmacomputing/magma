...
export default defineConfig({
	...
	resolve: {
		alias: isDist ? [
			...
			{ find: /^#tempo\/plugin\.(.*)\.js$/, replacement: resolve(__dirname, './dist/plugin/plugin.$1.js') },
			{ find: /^#tempo\/plugin\/(.*)\.js$/, replacement: resolve(__dirname, './dist/plugin/$1.js') },
			{ find: /^#tempo\/plugin$/, replacement: resolve(__dirname, './dist/plugin/plugin.index.js') },
			...
			{ find: /^@magmacomputing\/tempo\/(parse|format|mutate|duration)$/, replacement: resolve(__dirname, './src/module/module.$1.ts') },
			{ find: /^@magmacomputing\/tempo\/module\/(.*)$/, replacement: resolve(__dirname, './src/module/$1.ts') },
			{ find: /^@magmacomputing\/tempo\/support$/, replacement: resolve(__dirname, './src/support/support.index.ts') },
			{ find: /^@magmacomputing\/tempo\/enums$/, replacement: resolve(__dirname, './src/support/support.enum.ts') },
			...
			{ find: /^#tempo\/plugin\.(.*)\.js$/, replacement: resolve(__dirname, './src/plugin/plugin.$1.ts') },
			{ find: /^#tempo\/plugin\/(.*)\.js$/, replacement: resolve(__dirname, './src/plugin/$1.ts') },
			{ find: /^#tempo\/plugin$/, replacement: resolve(__dirname, './src/plugin/plugin.index.ts') },
			...
			{ find: /^@magmacomputing\/library\/(browser|server)\/(.*?)(\.js)?$/, replacement: resolve(__dirname, '../library/src/$1/$2.ts') },
