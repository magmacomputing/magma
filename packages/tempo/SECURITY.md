...
Alternatively, you may submit a private security advisory through the **Security** tab of our GitHub repository: [Submit Security Advisory](https://github.com/magmacomputing/magma/security/advisories/new).
...
- The package name and version affected (e.g. `@magmacomputing/tempo@4.0.1`).
