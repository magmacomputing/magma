...
export const isObject = (obj: any): obj is Property<any> => isType(obj, 'Object');
...
export const isNullish = (obj: any): obj is Nullish => isType<undefined | null | void>(obj, 'Null', 'Undefined', 'Void', 'Empty');
export const isUndefined = (obj: any): obj is undefined => isType<undefined>(obj, 'Undefined', 'Void', 'Empty');
...
export const isMap = (obj: any): obj is Map<any, any> => isType(obj, 'Map');
export const isSet = (obj: any): obj is Set<any> => isType(obj, 'Set');
