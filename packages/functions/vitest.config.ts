...
export default defineConfig({
	...
	resolve: {
		alias: [
			...
			{ find: /^#tempo\/config$/, replacement: resolve(__dirname, '../tempo/src/config/config.index.ts') },
			{ find: /^#tempo\/enums$/, replacement: resolve(__dirname, '../tempo/src/support/support.enum.ts') },
			{ find: /^#tempo\/term$/, replacement: resolve(__dirname, '../tempo/src/plugin/term/term.index.ts') },
			{ find: /^#tempo\/tempo\.class\.js$/, replacement: resolve(__dirname, '../tempo/src/tempo.class.ts') },
			...
			{ find: /^@magmacomputing\/library\/(common|browser|server)\/(.*)\.js$/, replacement: resolve(__dirname, '../library/src/$1/$2.ts') },
			{ find: /^@magmacomputing\/library\/(common|browser|server)\/(.*)$/, replacement: resolve(__dirname, '../library/src/$1/$2.ts') },
			{ find: /^@magmacomputing\/library\/common$/, replacement: resolve(__dirname, '../library/src/common.index.ts') },
			{ find: /^@magmacomputing\/library\/browser$/, replacement: resolve(__dirname, '../library/src/browser.index.ts') },
			{ find: /^@magmacomputing\/library\/server$/, replacement: resolve(__dirname, '../library/src/server.index.ts') },
			{ find: /^@magmacomputing\/library\/(.*)\.js$/, replacement: resolve(__dirname, '../library/src/common/$1.ts') },
			{ find: /^@magmacomputing\/library\/(.*)$/, replacement: resolve(__dirname, '../library/src/common/$1.ts') },
			...
			{ find: /^@magmacomputing\/tempo\/config$/, replacement: resolve(__dirname, '../tempo/src/config/config.index.ts') },
			{ find: /^@magmacomputing\/tempo\/enums$/, replacement: resolve(__dirname, '../tempo/src/support/support.enum.ts') },
			...
			{ find: /^@magmacomputing\/tempo\/term\/standard$/, replacement: resolve(__dirname, '../plugins/.std/src/index.ts') },
			{ find: /^@magmacomputing\/tempo\/term\/quarter$/, replacement: resolve(__dirname, '../plugins/.std/src/term.quarter.ts') },
			{ find: /^@magmacomputing\/tempo\/term\/season$/, replacement: resolve(__dirname, '../plugins/.std/src/term.season.ts') },
			{ find: /^@magmacomputing\/tempo\/term\/zodiac$/, replacement: resolve(__dirname, '../plugins/.std/src/term.zodiac.ts') },
			{ find: /^@magmacomputing\/tempo\/term\/timeline$/, replacement: resolve(__dirname, '../plugins/.std/src/term.timeline.ts') },
